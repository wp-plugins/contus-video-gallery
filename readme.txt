...
* HTML 5
* Easy to install Contus Video Gallery Plugin comes with complete control on player through admin panel, with fantastic support.
...
* Playlist Option available in this Contus Video Gallery Version.
...
= Basic Installation =
1. Download and unzip the current version of the Contus Video Gallery plugin.
2. Transfer the entire Contus Video Gallery directory to your /wp-content/plugins/ directory
3. Activate the Contus Video Gallery plugin through the 'Plugins' menu in WordPress
...
2. Media -> Contus Video Gallery - > Add Video.
...
Download the zip file , install it and then rename the plugin name as contus-video-gallery.Then activate the plugin.

= Where can I see the working demo of this Video Player or Video Plugin? =
You can see the demo of our Contus Video Gallery Version or Video Plugin in this link - http://www.hdflvplayer.net/wordpress-video-gallery/demo/
...
= Can I get the Contus Video Gallery plugin player customized to my needs? =
...
= How to replace or remove the HD FLV Player demo logo from this Contus Video Gallery? =
