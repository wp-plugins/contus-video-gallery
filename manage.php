...
// Generates retrieve request.
        $tables = $wpdb->get_results("SELECT * FROM " . $wpdb->prefix . "hdflvvideoshare" . $join . $where . $orderby . "");
?>
        ...
        <div class="wrap">
            <form name="filterType" method="post" id="posts-filter">
                ...
                <div style='background:#D0D0D0;list-style:none;width:850px;float:left'><p style='padding-left:6px'>You can also set different width,height.Player settings can directly give in the flashvars for the player in different posts irrespective of the values specified here.<br><br>

                        <b>For example:</b>[hdvideo id=3 playlistid=2 width=400 height=400 ] or [hdvideo playlistid=2 ] or [hdvideo id=3 ] or [hdvideo id=3 flashvars="autoplay=true & zoom=false"] <br><br>* id will be created when you add videos in the manage Video section</p></div><div style=float:left;color:red;>&nbsp;&nbsp;&nbsp;<a style=color:red; href="options-general.php?page=hdflvvideoshare.php"><?php _e('Options->Contus Video Gallery Settings', 'hdflvvideoshare') ?></a></div><div style=clear:both></div>
                <ul class="subsubsub">
                    <li>&nbsp;</li>
                </ul>
                <p class="search-box">
...
<?php
        if ($tables) {
            ...
            foreach ($tables as $table) {
               ...
               <?php echo "<td>" . htmlspecialchars(stripslashes($table->file), ENT_QUOTES) . "</td>\n";
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td><input type="text" size="80" name="act_link" value="<?php echo $act_link ?>" />
                                <br /><?php _e('Enter the URL to the page/file, if you click on the player', 'hdflvvideoshare') ?></td>
                        </tr>
                        <tr>
                            <th scope="row"><?php _e('Feature', 'hdflvvideoshare') ?></th>
                            <td>
<?php //echo $act_feature;  ?>
                                <input type="radio" name="feature" value="ON" value="" <?php if ($act_feature == 'ON') {
                echo "checked";
            } ?>>ON
                                <input type="radio" name="feature" value="OFF" value="" <?php if ($act_feature == 'OFF') {
                echo "checked";
            } ?>>OFF
                         ...
                         <tr>
                            ...
                            <td>
<?php //echo $act_feature;  ?>
                                <input type="radio" name="download" value="1" <?php if ($act_download == '1') {
                echo "checked";
            } ?>>YES
                                <input type="radio" name="download" value="0"  <?php if ($act_download == '0') {
                echo "checked";
            } ?>>NO
                         ...
                         <tr valign="top">
                            ...
                            <td>
                                ...
                                <select name="act_prerollads">
                                    ...
                                    <option
                                        <?php echo 'name="'.$table->ads_id .'" value="'. $table->ads_id .'"' ;
                                                if( $table->ads_id == $act_prerollads){ echo 'selected=selected'; }
                         ...
                         <tr valign="top">
                            ...
                            <td>
                                ...
                                <select name="act_postrollads">
                                    ...
                                    <option
                                        <?php echo 'name="'.$table->ads_id .'" value="'. $table->ads_id .'"' ;
                                                if( $table->ads_id == $act_postrollads){ echo 'selected=selected'; }
                                                        ?> ><?php  echo $table->title ; ?>
                                    </option>
                                    <?php } ?>
                                </select>
                ...
                <div id="submitdiv" class="postbox">
                    ...
                    <div class="inside" style="color:blue" >
                        <div id="submitpost" class="submitbox">
                            <div class="misc-pub-section">
                                <p>
<?php _e('See global settings for the Contus Video Gallery under', 'hdflvvideoshare') ?> <a href="options-general.php?page=hdflvvideoshare.php"><?php _e('Options->Contus Video Gallery Settings', 'hdflvvideoshare') ?></a>
                                </p>
                            </div>
                            ...
                            <table class="form-table">
                                <tr>
                                 ...
                                 <tr>
                                    <th scope="row"><?php _e('Feature','hdflvvideoshare') ?></th>
                                    <td>
                                        <input type="radio" name="feature" value="ON">ON
                                        <input type="radio" name="feature" value="OFF">OFF
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="radio" name="download" value="0">ON
