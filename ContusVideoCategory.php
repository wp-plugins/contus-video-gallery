...
<?php
        ...
        $div='';
        $div .= '<div id="videos-category"  class="sidebar-wrap clearfix"> <h3 class="widget-title"><a href="' . $site_url . '/?page_id=' . $moreName . '&more=categories">' . __('Video Categories', 'video_gallery') . '</a></h3>';
